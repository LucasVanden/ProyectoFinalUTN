...
$_SESSION['horariosdeMesasAagregar']=null;
//    GET DATOS
...
$_SESSION['dedicacionCreacion']=$dedicaciondoble;
...
if($dedicaciondoble){
    ...
    $_SESSION['dia1S_2']=$dia1erSemestre2;
    $_SESSION['hora1S_2']=$hora1erSemestre2;
    $_SESSION['min1S_2']=$min1erSemestre2;

    $_SESSION['dia2S_2']=$dia2doSemestre2;
    $_SESSION['hora2S_2']=$hora2doSemestre2;
    $_SESSION['min2S_2']=$min2doSemestre2;
}

$_SESSION['dia1S_1']=$dia1erSemestre1;
$_SESSION['hora1S_1']=$hora1erSemestre1;
$_SESSION['min1S_1']=$min1erSemestre1;

$_SESSION['dia2S_1']=$dia2doSemestre1;
$_SESSION['hora2S_1']=$hora2doSemestre1;
$_SESSION['min2S_1']=$min2doSemestre1;

//semestre actual
$semestreactual;
mesActual();
$_SESSION['semestreactualCreacion']=$semestreactual;
...
//doble
if($dedicaciondoble){
    ComprobarSuperposicionEntreLosHorariosAsignados($dia1erSemestre1,$hora1erSemestre1,$min1erSemestre1,$dia1erSemestre2,$hora1erSemestre2,$min1erSemestre2,$dia2doSemestre1,$hora2doSemestre1,$min2doSemestre1,$dia2doSemestre2,$hora2doSemestre2,$min2doSemestre2);
...
if(!empty($mensajes)){
    ...
    $_SESSION['CreacionHorariosComunes']=true;
