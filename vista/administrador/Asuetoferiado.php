...
if(isset($_SESSION['idfechaferiado'])){
    $fechadesdeVerano=$_SESSION['idfechaferiado'];
}
?>
...
<!-- Calendario -->
<form action=<?php echo $marcarAsuetoFeriado?> method="POST" class="form-horizontal" target="dummyframe">
    ...
    <div id="div">
        <main >
            ...
            <div >
                <?php $month="01";
                $listaAsuetos=$con->ConsultarAsuetoFeriado($year,$month); ?>
                <div class="month">      
                    <ul>
                        <li>
