...
if (!empty($_POST['usuario']) && !empty($_POST['contrasenia'])) {
    $records = $conn->prepare('SELECT id, usuario, contrasenia FROM usuarios WHERE usuario = :usuario');
...
<html>
    ...
    <body>
        ...
        <form action="login.php" method="POST">
            Usuario <input name="usuario" type="text" placeholder="Ingrese Usuario" required="">
